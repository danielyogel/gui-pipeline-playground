...
export default function RouterFactory<T extends Record<string, string>>(routes: T, defaultRoute: keyof T) {
...
export type routerType = ReturnType<typeof RouterFactory>;
